...
// import HomeParalax from "../pages/HomeParalax/HomeParalax";
...
function AppRoutes() {
  return (
    <Routes>
      ...
      <Route
        path="/servicios/detalles/:service_id"
        element={<ServiceDetailsPage />}
      />
      {/* <Route path="/home2" element={<HomeParalax />} /> */}
      <Route element={<PrivateRoute />}>
        <Route path="/usuario/mi-perfil" element={<Profile />} />
        <Route
          path="/servicios/editar-servicio/:service_id"
          element={<p>EDITAR</p>}
        />
      </Route>
